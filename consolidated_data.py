...
def resize_image(path,title,ext):
    image = Image.open(path+'/'+title+ext)
    new_image = image.resize((600, 400))
    new_image.save(path+'/'+title+ext)
...
resize_image(path_resources,'a','.png')
resize_image(path_resources,'b','.png')
resize_image(path_resources,'c','.png')
resize_image(path_resources,'d','.png')
resize_image(path_resources,'e','.png')
resize_image(path_resources,'f','.png')
resize_image(path_resources,'g','.png')
resize_image(path_resources,'h','.png')
resize_image(path_resources,'i','.png')
resize_image(path_resources,'j','.png')
resize_image(path_resources,'k','.png')
resize_image(path_resources,'l','.png')
